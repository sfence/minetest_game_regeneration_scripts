...
if [ $# -le 2 ]; then
  echo "Usage:"
  echo "  hades_master.sh game_id game_dir mods_dir"
  exit
fi
...
# mods church_grave, church_cross, church_podium, church_pews, church_altar, church_candles, font_lib, church_glass, church_bell, display_lib
echo "Getting mods church_grave, church_cross, church_podium, church_pews, church_altar, church_candles, font_lib, church_glass, church_bell, display_lib"
...
# mods hades_extravessels, hades_extrafarming, hades_craftguide2, hades_castle_lighting, hades_castle_gates, hades_animals, hades_horse, hades_boost_cart, hades_clothing, hades_castle_masonry, hades_bucket, hades_xpanes, hades_fachwerk, hades_rocks, hades_moretools, hades_moreblocks, hades_extramaterials, hades_default, hades_glass_stained, hades_digtron
echo "Getting mods hades_extravessels, hades_extrafarming, hades_craftguide2, hades_castle_lighting, hades_castle_gates, hades_animals, hades_horse, hades_boost_cart, hades_clothing, hades_castle_masonry, hades_bucket, hades_xpanes, hades_fachwerk, hades_rocks, hades_moretools, hades_moreblocks, hades_extramaterials, hades_default, hades_glass_stained, hades_digtron"
...
# mods hades_petz, hades_bale, hades_mokapi
echo "Getting mods hades_petz, hades_bale, hades_mokapi"
...
# mods adaptation_hades_revisited, adaptation_power_generators, adaptation_technic, adaptation_lib, adaptation_moretrees, adaptation_pipeworks, adaptation_elepower, adaptation_basic_materials, adaptation_hades_extensionmods, adaptation_cool_trees, adaptation_techage, adaptation_farming_redo, adaptation_biofuel, adaptation_mineclone, adaptation_mesecons, adaptation_minetest_game, adaptation_farlands_reloaded, adaptation_xocean, adaptation_rubber
echo "Getting mods adaptation_hades_revisited, adaptation_power_generators, adaptation_technic, adaptation_lib, adaptation_moretrees, adaptation_pipeworks, adaptation_elepower, adaptation_basic_materials, adaptation_hades_extensionmods, adaptation_cool_trees, adaptation_techage, adaptation_farming_redo, adaptation_biofuel, adaptation_mineclone, adaptation_mesecons, adaptation_minetest_game, adaptation_farlands_reloaded, adaptation_xocean, adaptation_rubber"
...
# mods hades_mr_goat, hades_better_rat, hades_doomed, hades_butterfly, hades_bat, hades_snowman, hades_birds, hades_fish, hades_bear, hades_wolf, hades_giraffe, hades_turtles, hades_walrus, hades_deer, hades_jellyfish, hades_bugslive
echo "Getting mods hades_mr_goat, hades_better_rat, hades_doomed, hades_butterfly, hades_bat, hades_snowman, hades_birds, hades_fish, hades_bear, hades_wolf, hades_giraffe, hades_turtles, hades_walrus, hades_deer, hades_jellyfish, hades_bugslive"
...
# mods hades_jacaranda, hades_clementinetree, hades_lemontree, hades_oak, hades_cacaotree, hades_birch, hades_ebony, hades_pomegranate, hades_pineapple, hades_chestnuttree, hades_plumtree, hades_baldcypress, hades_willow, hades_sequoia, hades_larch, hades_bamboo, hades_cherrytree, hades_palm, hades_mahogany, hades_hollytree, hades_maple
echo "Getting mods hades_jacaranda, hades_clementinetree, hades_lemontree, hades_oak, hades_cacaotree, hades_birch, hades_ebony, hades_pomegranate, hades_pineapple, hades_chestnuttree, hades_plumtree, hades_baldcypress, hades_willow, hades_sequoia, hades_larch, hades_bamboo, hades_cherrytree, hades_palm, hades_mahogany, hades_hollytree, hades_maple"
...
# mods hades_mesecons_hydroturbine, hades_mesecons_detector, hades_mesecons_button, hades_mesecons_luacontroller, hades_mesecons_extrawires, hades_mesecons_materials, hades_mesecons_solarpanel, hades_mesecons_lamp, hades_mesecons_gates, hades_mesecons_noteblock, hades_mesecons_lightstone, hades_mesecons_fpga, hades_mesecons_random, hades_mesecons_stickyblocks, hades_mesecons_wires, hades_mesecons_blinkyplant, hades_mesecons_pistons, hades_mesecons_torch, hades_mesecons_switch, hades_mesecons_alias, hades_mesecons_pressureplates, hades_mesecons_mvps, hades_mesecons_delayer, hades_mesecons_doors, hades_mesecons_walllever, hades_mesecons_receiver, hades_mesecons_powerplant, hades_mesecons_movestones, hades_mesecons_microcontroller, hades_mesecons_insulated, hades_mesecons, hades_mesecons_commandblock
echo "Getting mods hades_mesecons_hydroturbine, hades_mesecons_detector, hades_mesecons_button, hades_mesecons_luacontroller, hades_mesecons_extrawires, hades_mesecons_materials, hades_mesecons_solarpanel, hades_mesecons_lamp, hades_mesecons_gates, hades_mesecons_noteblock, hades_mesecons_lightstone, hades_mesecons_fpga, hades_mesecons_random, hades_mesecons_stickyblocks, hades_mesecons_wires, hades_mesecons_blinkyplant, hades_mesecons_pistons, hades_mesecons_torch, hades_mesecons_switch, hades_mesecons_alias, hades_mesecons_pressureplates, hades_mesecons_mvps, hades_mesecons_delayer, hades_mesecons_doors, hades_mesecons_walllever, hades_mesecons_receiver, hades_mesecons_powerplant, hades_mesecons_movestones, hades_mesecons_microcontroller, hades_mesecons_insulated, hades_mesecons, hades_mesecons_commandblock"
...
# mods hades_wrench, hades_concrete, hades_extranodes, hades_technic_chests, hades_technic, hades_technic_worldgen, hades_technic_cnc
echo "Getting mods hades_wrench, hades_concrete, hades_extranodes, hades_technic_chests, hades_technic, hades_technic_worldgen, hades_technic_cnc"
...
git -C $repodir checkout 270342ff43e5a2004fde04ce2b018314dd4cc62d
...
# mods morelights_vintage, morelights_modern, morelights_extras, morelights
echo "Getting mods morelights_vintage, morelights_modern, morelights_extras, morelights"
...
git -C $repodir checkout 92202fa533e98e63a5b0b53b0d91167611b1df4a
...
git -C $repodir checkout 7cb342e8a7ad1804375f9fa5b548571d6e0b9422
...
git -C $repodir checkout b878f06b7cc32f8d16f0521201b6a8656b1028a2
...
# mod hades_metamorphosis
echo "Getting mod hades_metamorphosis"
# place insert code for mod hades_metamorphosis here
...
# mods church_grave, church_cross, church_podium, church_pews, church_altar, church_candles, font_lib, church_glass, church_bell, display_lib commit check
repodir=$modsdir/church
...
# mods hades_petz, hades_bale, hades_mokapi commit check
repodir=$modsdir/hades_petz
...
# mods adaptation_hades_revisited, adaptation_power_generators, adaptation_technic, adaptation_lib, adaptation_moretrees, adaptation_pipeworks, adaptation_elepower, adaptation_basic_materials, adaptation_hades_extensionmods, adaptation_cool_trees, adaptation_techage, adaptation_farming_redo, adaptation_biofuel, adaptation_mineclone, adaptation_mesecons, adaptation_minetest_game, adaptation_farlands_reloaded, adaptation_xocean, adaptation_rubber commit check
repodir=$modsdir/adaptation_modpack
...
# mods hades_mr_goat, hades_better_rat, hades_doomed, hades_butterfly, hades_bat, hades_snowman, hades_birds, hades_fish, hades_bear, hades_wolf, hades_giraffe, hades_turtles, hades_walrus, hades_deer, hades_jellyfish, hades_bugslive commit check
repodir=$modsdir/hades_animal_pack
...
# mods hades_mesecons_hydroturbine, hades_mesecons_detector, hades_mesecons_button, hades_mesecons_luacontroller, hades_mesecons_extrawires, hades_mesecons_materials, hades_mesecons_solarpanel, hades_mesecons_lamp, hades_mesecons_gates, hades_mesecons_noteblock, hades_mesecons_lightstone, hades_mesecons_fpga, hades_mesecons_random, hades_mesecons_stickyblocks, hades_mesecons_wires, hades_mesecons_blinkyplant, hades_mesecons_pistons, hades_mesecons_torch, hades_mesecons_switch, hades_mesecons_alias, hades_mesecons_pressureplates, hades_mesecons_mvps, hades_mesecons_delayer, hades_mesecons_doors, hades_mesecons_walllever, hades_mesecons_receiver, hades_mesecons_powerplant, hades_mesecons_movestones, hades_mesecons_microcontroller, hades_mesecons_insulated, hades_mesecons, hades_mesecons_commandblock commit check
repodir=$modsdir/hades_mesecons
...
# mods hades_wrench, hades_concrete, hades_extranodes, hades_technic_chests, hades_technic, hades_technic_worldgen, hades_technic_cnc commit check
repodir=$modsdir/hades_technic
...
repodir=$modsdir/sfence_help
if [ $(git -C $repodir rev-parse HEAD) != 270342ff43e5a2004fde04ce2b018314dd4cc62d ]; then
...
# mods morelights_vintage, morelights_modern, morelights_extras, morelights commit check
repodir=$modsdir/morelights
...
repodir=$modsdir/writing
if [ $(git -C $repodir rev-parse HEAD) != 92202fa533e98e63a5b0b53b0d91167611b1df4a ]; then
...
repodir=$modsdir/hades_laboratory
if [ $(git -C $repodir rev-parse HEAD) != 7cb342e8a7ad1804375f9fa5b548571d6e0b9422 ]; then
...
repodir=$modsdir/hades_paleotest
if [ $(git -C $repodir rev-parse HEAD) != b878f06b7cc32f8d16f0521201b6a8656b1028a2 ]; then
